    ...
    <xsl:template match="/bibliography">
        <div style="margin: 25px 25px 25px 25px;">
            <div style="width:100%; display:flex; align-items: center;">
                <div style="width: 30%;">
                    <img src="HTWK_Zusatz_en_H_Black_sRGB.svg" alt="WisLogo" style="width: 300px; height: 100px;"/>
                </div>
            </div>
            <h1>
            ...
            <p>
                ...
                collaborate on a project focusing
                on extracting BibTeX data from
                <b>
                    <xsl:value-of select="bibtitle"/>
                </b>
                and utilizing Excel for
